...
public class Jaccard {
	...
	public static void main(String[] args) {
		...
		ArrayList<String> hashB = new ArrayList<String>();
		...
		ArrayList<String> i2r = new ArrayList(Arrays.asList(i2.split(" ")));
		ArrayList<String> i3r = new ArrayList(Arrays.asList(i3.split(" ")));
		Jaccard jack = new Jaccard();
		ArrayList<String> i2p = new ArrayList();
		ArrayList<String> i3p = new ArrayList();
		jack.apply(i2r,i3r);
		jack.apply(i2r,i2r);
		System.exit(0);
	...
	float apply(ArrayList<String> hashA,ArrayList<String> hashB) {
		float similarity = 0f;
